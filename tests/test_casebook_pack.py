"""Regression checks for the binary-move-tablebase-scope casebook."""
...
from casebook.harness import assert_expected, binary_move_tablebase_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(binary_move_tablebase_scope_summary(), assert_expected())
